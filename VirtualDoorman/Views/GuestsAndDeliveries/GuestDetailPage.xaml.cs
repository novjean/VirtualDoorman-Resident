...
namespace VirtualDoorman.Views.GuestsAndDeliveries
{
    public partial class GuestDetailPage : ContentPage
    {
        ...
        //Adding New Guest Constructor
        public GuestDetailPage(User userObject, Guest newGuest)
        {
        ...
        //Hardcoded list of the cell phone providers
